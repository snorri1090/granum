...
class DMPRO_RestaurantMenu extends ET_Builder_Module { 
	...
	public $module_url = DMPRO_MODULES_URL . 'RestaurantMenu' . '/';
    ...
    public function init() {
        ...
        $this->vb_support = 'on';
        $this->name = esc_html__(DMPRO_PREFIX . 'Restaurant Menu', DMPRO_TEXTDOMAIN);
        $this->child_slug = 'dmpro_price_list_item';
        $this->settings_modal_toggles = [
            'general' => [
                'toggles' => [
                    'title' => esc_html__('Title', DMPRO_TEXTDOMAIN),
                    'price' => esc_html__('Price', DMPRO_TEXTDOMAIN),
                    'description' => esc_html__('Desription', DMPRO_TEXTDOMAIN),
                ],
            ],
            'advanced' => [
                'toggles' => [
                    'layout' => esc_html__('Vertical Alignment', DMPRO_TEXTDOMAIN),
                    'image' => esc_html__('Image', DMPRO_TEXTDOMAIN),
                    'separator' => esc_html__('Title & Price Separator', DMPRO_TEXTDOMAIN),
                    'text' => [
    ...
    public function get_fields() {
        ...
        $fields['image_flex_align_items'] = [
            'label' => esc_html__('Image Vertical Alignment', DMPRO_TEXTDOMAIN),
            'description' => esc_html__('How the image is vertically aligned inside each item.', DMPRO_TEXTDOMAIN),
            'type' => 'select',
            'options' => [
                'flex-start' => 'Top',
                'center' => 'Center',
        ...
        $fields['header_flex_align_items'] = [
            'label' => esc_html__('Header Vertical Alignment', DMPRO_TEXTDOMAIN),
            'description' => esc_html__('How the title, separator and price is vertically aligned inside the header.', DMPRO_TEXTDOMAIN),
            'type' => 'select',
            'options' => [
                'flex-start' => 'Top',
                'center' => 'Center',
        ...
        $fields['item_spacing'] = [
            'label' => esc_html__('Item Spacing', DMPRO_TEXTDOMAIN),
            'description' => esc_html__('The vertical spacing between each item.', DMPRO_TEXTDOMAIN),
            'type' => 'range',
            'tab_slug' => 'advanced',
        ...
        $fields["item_padding"] = [
            ...
            'description' => esc_html__('The padding inside each item.', DMPRO_TEXTDOMAIN),
            'type' => 'custom_margin',
            'mobile_options' => true,
        ...
        $fields["item_text_padding"] = [
            'label' => esc_html__('Item Text Wrapper Padding', DMPRO_TEXTDOMAIN),
            'description' => esc_html__('The padding of the text container.', DMPRO_TEXTDOMAIN),
            'type' => 'custom_margin',
            'mobile_options' => true,
            'option_category' => 'layout',
            'tab_slug' => 'advanced',
        ...
        $fields['image_spacing'] = [
            'label' => esc_html__('Image Spacing', DMPRO_TEXTDOMAIN),
            'description' => esc_html__('The spacing between the image and the text container.', DMPRO_TEXTDOMAIN),
            'type' => 'range',
            'tab_slug' => 'advanced',
            'toggle_slug' => 'image',
            'default' => '0px',
        ...
        $fields['image_width'] = [
            ...
            'description' => esc_html__('The width of the image of each item.', DMPRO_TEXTDOMAIN),
            'type' => 'range',
            'tab_slug' => 'advanced',
            'toggle_slug' => 'image',
            'range_settings' => array(
        ...
        $fields['separator_style'] = [
            'label' => esc_html__('Separator Style', DMPRO_TEXTDOMAIN),
            'description' => esc_html__('The CSS border-style used for the separator.', DMPRO_TEXTDOMAIN),
            'type' => 'select',
            'options' => [
                'none' => 'none',
                'dotted' => 'dotted',
        ...
        $fields['separator_weight'] = [
            'label' => esc_html__('Separator Height', DMPRO_TEXTDOMAIN),
            'description' => esc_html__('The CSS border-width used for the separator.', DMPRO_TEXTDOMAIN),
            'type' => 'range',
            'tab_slug' => 'advanced',
            'toggle_slug' => 'image',
            'default' => '2px',
        ...
        $fields['separator_color'] = [
            ...
            'description' => esc_html__('The CSS border-color used for the separator.', DMPRO_TEXTDOMAIN),
            'type' => 'color-alpha',
            'custom_color' => true,
        ...
        $fields['separator_spacing'] = [
            ...
            'description' => esc_html__('The spacing between the title/price and the separator.', DMPRO_TEXTDOMAIN),
            'type' => 'range',
            'tab_slug' => 'advanced',
            'toggle_slug' => 'separator',
            'default' => '5px',
    ...
    public function get_custom_css_fields_config() {
        ...
        $custom_css_fields['price_list_item'] = [
            'label' => esc_html__('Price List Items', DMPRO_TEXTDOMAIN),
            'selector' => '%%order_class%% .dmpro_price_list_item',
        ];

        $custom_css_fields['img_wrap'] = [
            'label' => esc_html__('Image Wrapper', DMPRO_TEXTDOMAIN),
        ...
        $custom_css_fields['txt_wrap'] = [
            'label' => esc_html__('Text Wrapper', DMPRO_TEXTDOMAIN),
        ...
        $custom_css_fields['separator'] = [
            'label' => esc_html__('Title & Price Separator', DMPRO_TEXTDOMAIN),
    ...
    public function render($attrs, $content, $render_slug) {
        ...
        et_pb_responsive_options()->generate_responsive_css($image_width_values, '%%order_class%%', 'image_spacing', $render_slug);
        et_pb_responsive_options()->generate_responsive_css($image_spacing_values, '%%order_class%%', 'image_spacing', $render_slug);
