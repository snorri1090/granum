...
class DMPRO_ButtonGridiron_Child extends ET_Builder_Module {
	...
	public $module_url = DMPRO_MODULES_URL . 'ButtonGridiron_Child' . '/';
	
    public function init() {
        $this->slug = 'dmpro_button_grid_child';
        $this->vb_support = 'on';
        $this->type = 'child';
        $this->name = esc_html__('Multi Button', DMPRO_TEXTDOMAIN);
        $this->main_css_element = '%%order_class%%.dmpro_button_grid_child';
        $this->child_title_var = 'button_id';
        $this->advanced_setting_title_text = esc_html__('New Button', DMPRO_TEXTDOMAIN);
        $this->settings_text = esc_html__('Button Content', DMPRO_TEXTDOMAIN);
        $this->settings_modal_toggles = [
            'general' => [
                'toggles' => [
                    'general' => esc_html__('General Settings', DMPRO_TEXTDOMAIN),
                    'button_info' => esc_html__('Button Content', DMPRO_TEXTDOMAIN),
                    'text_info' => esc_html__('Text Content', DMPRO_TEXTDOMAIN),
                ],
            ],
            'advanced' => [
                'toggles' => [
                    'text_style' => esc_html__('Text Style', DMPRO_TEXTDOMAIN)
                ]
            ]
        ];
    }
    ...
    public function get_fields() {
        ...
        $module_fields['button_type'] = [
            'label' => esc_html__('Button Type', DMPRO_TEXTDOMAIN),
            'type' => 'select',
            'option_category' => 'configuration',
            'options' => [
                '' => esc_html__('Select Type', DMPRO_TEXTDOMAIN),
        ...
        $module_fields["button_link_target"] = [
            ...
            'depends_show_if' => 'button',
            'toggle_slug' => 'button_info',
			'description' => esc_html__( 'Choose whether your link opens in a new window or not', DMPRO_TEXTDOMAIN ),
        ];
    ...
    public function get_advanced_fields_config() {
        ...
        $advanced_fields['button']["button"] = [
            'label'    => esc_html__('Button Style', DMPRO_TEXTDOMAIN),
            'css' => [
    ...
    public function get_custom_css_fields_config() {
        ...
        $custom_css_fields['text_type'] = array(
            'label' => esc_html__('Text Style', DMPRO_TEXTDOMAIN),
