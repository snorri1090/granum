...
class DMPRO_Timeline extends ET_Builder_Module {
	...
	public $module_url = DMPRO_MODULES_URL . 'TimeLine' . '/';
	...
	public function init() 
	{
		...
		$this->settings_modal_toggles = [
			'general'    => [
				'toggles' => [
					'card_arrow_settings' => esc_html__('Event Card Arrow', DMPRO_TEXTDOMAIN),
				],
			],      
			'advanced'   => [
				'toggles' => [
				    'timeline_design' => [
				        'sub_toggles' => [
                            ...
                            'title' => esc_html__('Timeline Design Settings', DMPRO_TEXTDOMAIN),
                            'priority' => 1,
				        ],
                    'animation_timeline_settings' => esc_html__( 'Animation Timeline', DMPRO_TEXTDOMAIN ),
				],
			]
    ];
	...
	public function get_fields() {
		...
		$start_position['left'] = esc_html__('Left', DMPRO_TEXTDOMAIN);
		$start_position['right'] = esc_html__('Right', DMPRO_TEXTDOMAIN);
		return array(
			'show_card_arrow'  => array(
				'label'            => esc_html__( 'Show Event Card Arrow', DMPRO_TEXTDOMAIN ),
				'description'      => esc_html__( 'Enable this to Display the an arrow from the Timeline Event Card', DMPRO_TEXTDOMAIN ),
				'type'             => 'yes_no_button',
				'options'          => array(
			...
			'layout'      => array(
				'label'            => esc_html__( 'Timeline Layout', DMPRO_TEXTDOMAIN ),
				'type'             => 'select',
				'option_category'  => 'layout',
				'options'          => array(
          'left'           => esc_html__( 'Left', DMPRO_TEXTDOMAIN ),
          'right'          => esc_html__( 'Right', DMPRO_TEXTDOMAIN ),
          'mixed'          => esc_html__( 'Alternating', DMPRO_TEXTDOMAIN )
      ),
		'tab_slug'         => 'advanced',
		'toggle_slug' => 'timeline_design',
		'sub_toggle'      => 'layout_settings',
		'description'      => esc_html__( 'Choose to display your timeline event cards to the left, right, or alternating.', DMPRO_TEXTDOMAIN ),
        ...
        'mobile_options'   => true,
			...
			'start_position'      => array(
				'label'            => esc_html__( 'Start Position', DMPRO_TEXTDOMAIN ),
				'type'             => 'select',
				'option_category'  => 'layout',
				...
				'toggle_slug' => 'timeline_design',
				'sub_toggle'      => 'layout_settings',
				'description'      => esc_html__( 'Choose which side you want your first timeline event card to display on.', DMPRO_TEXTDOMAIN ),
      ...
      'line_area_size'                  => array(
				'label'           => esc_html__( 'Line Container Width ', DMPRO_TEXTDOMAIN ),
				'description'     => esc_html__( 'Adjust the width of the entire line container.', DMPRO_TEXTDOMAIN ),
				'type'            => 'range',
				'option_category' => 'layout',
				'tab_slug'        => 'advanced',
				'toggle_slug' => 'timeline_design',
      ...
      'timeline_line_width' => array(
				'label'            => esc_html__( 'Line Width', DMPRO_TEXTDOMAIN ),
				'description'      => esc_html__( 'Adjust the width of the connecting line of the timeline.', DMPRO_TEXTDOMAIN ),
				'type'             => 'range',
      ...
      'timeline_line_style'    => array(
				'label'           => esc_html__( 'Line Style', DMPRO_TEXTDOMAIN ),
				'description'     => esc_html__( 'Select the shape of the timeline line.', DMPRO_TEXTDOMAIN ),
				'type'            => 'select',
				'option_category' => 'layout',
      ...
      'timeline_line_color' => array(
				...
				'label'           => esc_html__( 'Line Color', DMPRO_TEXTDOMAIN ),
				'type'            => 'color-alpha',
				'description'     => esc_html__( 'Here you can define a custom color for the timeline line.', DMPRO_TEXTDOMAIN ),
				'tab_slug' => 'advanced',
				'toggle_slug' => 'timeline_design',
				'sub_toggle'     => 'timeline_line_settings',
        'default'         => '#f4f4f4',
      ...
      'use_active_line'  => array(
				'label'            => esc_html__( 'Use Progressing Line', DMPRO_TEXTDOMAIN ),
				'description'      => esc_html__( 'Enable this option to show a line that progresses the timeline as you scroll.', DMPRO_TEXTDOMAIN ),
				'type'             => 'yes_no_button',
				'options'          => array(
					'off' => esc_html__('No', DMPRO_TEXTDOMAIN),
					'on'  => esc_html__('Yes', DMPRO_TEXTDOMAIN),
      ...
      'timeline_active_line_width' => array(
				'label'            => esc_html__( 'Progressing Line Width', DMPRO_TEXTDOMAIN ),
				'description'      => esc_html__( 'Choose a width for the progessing line.', DMPRO_TEXTDOMAIN ),
				'type'             => 'range',
        'option_category'  => 'configuration',
        'show_if'          => array(
          'use_active_line' => 'on'
      ...
      'timeline_active_line_style'    => array(
				'label'           => esc_html__( 'Progressing Line Style', DMPRO_TEXTDOMAIN ),
				'description'     => esc_html__( 'Select the shape of the progressing line.', DMPRO_TEXTDOMAIN ),
				'type'            => 'select',
				'option_category' => 'layout',
				'options'         => et_builder_get_border_styles(),
        'show_if'          => array(
      ...
      'timeline_active_line_color' => array(
				'default'         => $et_accent_color,
				'label'           => esc_html__( 'Progressing Line Color', DMPRO_TEXTDOMAIN ),
				'type'            => 'color-alpha',
				'description'     => esc_html__( 'Here you can define a custom color for the progressing line.', DMPRO_TEXTDOMAIN ),
        'show_if'          => array(
          'use_active_line' => 'on'
        ),
				'tab_slug'        => 'advanced',
  ...
  public function get_transition_fields_css_props() {
    ...
    wp_enqueue_script("dmpro-".$this->slug, $this->module_url . 'custom.js', [],DMPRO_VERSION, true);
