...
class DMPRO_ImageHoverBox extends ET_Builder_Module {
	...
	public $module_url = DMPRO_MODULES_URL . 'ImageHoverBox' . '/';
    ...
    public function init()
    {
        ...
        $this->vb_support = 'on';
        $this->name = esc_html__(DMPRO_PREFIX . 'Hover Box', DMPRO_TEXTDOMAIN);
            ...
            'general' => [
                'toggles' => [
                    ...
                    'box_text' => [
                        ...
                        'title' => esc_html__('Hover Box Text', DMPRO_TEXTDOMAIN),
                        'priority' => 1,
                    ],
                    'settings' => esc_html__('Hover Box Settings', DMPRO_TEXTDOMAIN),
                ],
            ],
            'advanced' => [
                'toggles' => [
                    'box_background' => [
                        ...
                        'tabbed_subtoggles' => true,
                        'title' => esc_html__('Box Background', DMPRO_TEXTDOMAIN),
                        'priority' => 1,
                    ],
                    'box_icon_image' => [
                        'sub_toggles' => [
                        ...
                        'tabbed_subtoggles' => true,
                        'title' => esc_html__('Box Icon & Image', DMPRO_TEXTDOMAIN),
                        'priority' => 2,
                    ],
                    'content_text' => [
                        'sub_toggles' => [
                        ...
                        'tabbed_subtoggles' => true,
                        'title' => esc_html__('Default Text', DMPRO_TEXTDOMAIN),
                        'priority' => 49,
                    ],
                    'content_hover_text' => [
                        'sub_toggles' => [
                        ...
                        'tabbed_subtoggles' => true,
                        'title' => esc_html__('Hover Text', DMPRO_TEXTDOMAIN),
                        'priority' => 49,
                    ],
                ],
            ],
    ...
    public function get_fields() {
        ...
        $fields['content_title'] = [
            'label' => esc_html__('Default Box Title', DMPRO_TEXTDOMAIN),
            'type' => 'text',
        ...
        $fields['use_content_icon'] = [
            'label' => esc_html__('Enable Icon for Default Box', DMPRO_TEXTDOMAIN),
            'type' => 'yes_no_button',
            'options' => [
        ...
        $fields["content_image_alt"] = [
            'label' => esc_html__('Image Alt', DMPRO_TEXTDOMAIN),
            'type' => 'text',
            'option_category' => 'basic_option',
            'show_if' => ['use_content_icon' => 'off'],
            'toggle_slug' => 'box_text',
        ...
        $fields["content_image_width"] = [
            'label' => esc_html__('Content Image Width', DMPRO_TEXTDOMAIN),
            'type' => 'range',
            'validate_unit' => true,
            'default' => '100%',
            'default_unit' => '%',
        ...
        $fields['content_icon'] = [
            'label' => esc_html__('Content Icon', DMPRO_TEXTDOMAIN),
            'type' => 'select_icon',
            'default' => '5',
        ...
        $fields['body_text'] = [
            'label' => esc_html__('Body Text', DMPRO_TEXTDOMAIN),
            'type' => 'tiny_mce',
            'toggle_slug' => 'box_text',
            'sub_toggle'   => 'default'
        ];
        ...
        $fields['content_hover_title'] = [
            'label' => esc_html__('Hover Box Title', DMPRO_TEXTDOMAIN),
            'type' => 'text',
            'toggle_slug' => 'box_text',
            'sub_toggle'  => 'hover',
        ];
        ...
        $fields['use_content_hover_icon'] = [
            'label' => esc_html__('Enable Icon for Hover Box', DMPRO_TEXTDOMAIN),
            'type' => 'yes_no_button',
            'options' => [
                'off' => esc_html__('No', DMPRO_TEXTDOMAIN),
                'on' => esc_html__('Yes', DMPRO_TEXTDOMAIN),
        ...
        $fields["content_hover_image_width"] = [
            'label' => esc_html__('Hover Image Width', DMPRO_TEXTDOMAIN),
            'type' => 'range',
            'validate_unit' => true,
            'default' => '100%',
            'default_unit' => '%',
        ...
        $fields['content_hover_icon'] = [
            'label' => esc_html__('Hover Icon', DMPRO_TEXTDOMAIN),
            'type' => 'select_icon',
            'default' => '5',
        ...
        $fields['use_content_hover_button'] = [
            'label' => esc_html__('Enable Button for Hover Box', DMPRO_TEXTDOMAIN),
            'type' => 'yes_no_button',
            'default' => 'off',
            'options' => [
                'off' => esc_html__('No', DMPRO_TEXTDOMAIN),
        ...
        $fields["hover_type"] = [
            'label' => esc_html__('Hover Animation', DMPRO_TEXTDOMAIN),
            'type' => 'select',
            ...
            'options' => [
                ...
                'zoom' => esc_html__('Zoom', DMPRO_TEXTDOMAIN),
            ],
        ];

        $fields["hover_direction"] = [
            'label' => esc_html__('Slide Direction', DMPRO_TEXTDOMAIN),
            'type' => 'select',
            'toggle_slug' => 'settings',
            'default' => 'top',
            'options' => [
                'top' => esc_html__('Bottom to Top', DMPRO_TEXTDOMAIN),
                'bottom' => esc_html__('Top to Bottom', DMPRO_TEXTDOMAIN),
                'left' => esc_html__('Left to Right', DMPRO_TEXTDOMAIN),
                'right' => esc_html__('Right to Left', DMPRO_TEXTDOMAIN),
            ],
            'show_if_not' => [
        ...
        $fields["animation_speed"] = [
            'label' => esc_html__('Animation Speed', DMPRO_TEXTDOMAIN),
            'type' => 'range',
            'option_category' => 'basic_option',
            'default' => '600ms',
            'fixed_unit' => 'ms',
        ...
        $fields["hover_box_align_front"] = [
            'label' => esc_html__('Content Align', DMPRO_TEXTDOMAIN),
            'type' => 'select',
            'default' => 'center',
            'toggle_slug' => 'settings',
            'options' => [
                'top_left' => esc_html__('Top Left', DMPRO_TEXTDOMAIN),
                'top' => esc_html__('Center Top', DMPRO_TEXTDOMAIN),
                ...
                'bottom' => esc_html__('Center Bottom', DMPRO_TEXTDOMAIN),
                'bottom_right' => esc_html__('Bottom Right', DMPRO_TEXTDOMAIN),
            ],
        ];

        $fields["hover_box_align_back"] = [
            'label' => esc_html__('Hover Content Align', DMPRO_TEXTDOMAIN),
            'type' => 'select',
            'default' => 'center',
            'toggle_slug' => 'settings',
            'options' => [
        ...
        $fields['use_force_square'] = [
            'label' => esc_html__('Enable Square Hover Box', DMPRO_TEXTDOMAIN),
            'description' => esc_html__('When enabeld, the module will always be a perfect square. The height will automatically be set to the width of the module.', DMPRO_TEXTDOMAIN),
            'type' => 'yes_no_button',
            'default' => 'off',
            'options' => [
                'off' => esc_html__('No', DMPRO_TEXTDOMAIN),
        ...
        $fields["box_height"] = [
            'label' => esc_html__('Box Height', DMPRO_TEXTDOMAIN),
            'type' => 'range',
            'option_category' => 'basic_option',
            'default' => '400px',
            'range_settings' => [
        ...
        $additional_options['content_bg_color'] = [
            'label' => esc_html__('Default Box Background', DMPRO_TEXTDOMAIN),
        ...
        $additional_options['content_hover_bg_color'] = [
            'label' => esc_html__('Hover Box Background', DMPRO_TEXTDOMAIN),
            'type' => 'background-field',
            'base_name' => "content_hover_bg",
            'context' => "content_hover_bg_color",
            'option_category' => 'layout',
            'custom_color' => true,
            'default' => ET_Global_Settings::get_value('all_buttons_bg_color'),
            'depends_show_if' => 'on',
		...
		$additional_options[ "content_hover_bg_color" ]['background_fields'][ "content_hover_bg_gradient" ]['default'] = '';
		
		$additional_options[ "content_hover_bg_color" ]['background_fields'][ "content_hover_bg_color" ]['default'] = '';
		
		$additional_options[ "content_hover_bg_color" ]['background_fields'][ "content_hover_bg_image" ]['default'] = '';
		...
		$additional_options = array_merge($additional_options, $this->generate_background_options("content_hover_bg", 'skip', "advanced", "box_background", "content_hover_bg_color"));
        $additional_options = array_merge($additional_options, $this->generate_background_options("content_hover_bg", 'skip', "advanced", "box_background", "content_hover_bg_color"));
        $additional_options = array_merge($additional_options, $this->generate_background_options("content_hover_bg", 'skip', "advanced", "box_background", "content_hover_bg_color"));
    ...
    public function get_advanced_fields_config() {
        ...
        $advanced_fields["box_shadow"]["default"] = [
            'label' => esc_html__('Box Shadow', DMPRO_TEXTDOMAIN),
            'css' => [
        ...
        $advanced_fields['button']["content_hover_button"] = [
            'label' => esc_html__('Hover Button', DMPRO_TEXTDOMAIN),
            'css' => [
        ...
        $advanced_fields['box_shadow']['content_image'] = [
            'label' => esc_html__('Content Image Box Shadow', DMPRO_TEXTDOMAIN),
            'option_category' => 'layout',
            'tab_slug' => 'advanced',
            'show_if' => ['use_content_icon' => 'off'],
            'css' => [
        ...
        $advanced_fields['box_shadow']['content_hover_icon_image'] = [
            'label' => esc_html__('Hover Image Box Shadow', DMPRO_TEXTDOMAIN),
            'option_category' => 'layout',
            'tab_slug' => 'advanced',
            'show_if' => ['use_content_hover_icon' => 'off'],
            'css' => [
    ...
    public function get_custom_css_fields_config() {
        ...
        $custom_css_fields['content_card_container'] = [
            'label' => esc_html__('Content Card Container', DMPRO_TEXTDOMAIN),
            'selector' => '%%order_class%% .dmpro-hover-box-content',
        ];

        $custom_css_fields['content_image_icon'] = [
            'label' => esc_html__('Content Image/Icon', DMPRO_TEXTDOMAIN),
        ...
        $custom_css_fields['content_hover_description'] = [
            'label' => esc_html__('Hover Description', DMPRO_TEXTDOMAIN),
    ...
    public function render($attrs, $content, $render_slug) {
        ...
        wp_enqueue_script("dmpro-".$this->slug, $this->module_url . 'custom.js', array('dmpro_resize_sensor_script'), DMPRO_VERSION, true);
    ...
    private function apply_css($render_slug)
    {
        ...
        $this->process_background( ".dmpro-hover-box-content", "content_bg", $render_slug, 'sticky' );
		
        $this->process_background( ".dmpro-hover-box-hover", "content_hover_bg", $render_slug, 'hover' );
    }
