...
class DMPRO_ButtonGridiron extends ET_Builder_Module {
	...
	public $module_url = DMPRO_MODULES_URL . 'ButtonGridiron' . '/';
    ...
    public function init() {
        ...
        $this->name = esc_html__(DMPRO_PREFIX . 'Multi Button', DMPRO_TEXTDOMAIN);
        $this->main_css_element = '%%order_class%%.dmpro_button_grid';
        $this->settings_modal_toggles = [
            'general' => [
                'toggles' => [
                    'flexbox' => esc_html__('Position & Alignment', DMPRO_TEXTDOMAIN),
                ],
            ],
            'advanced' => [
                'toggles' => [
    ...
    public function get_fields() {
        ...
        $fields['flex_direction'] = [
            'label' => esc_html__('Grid Type', DMPRO_TEXTDOMAIN),
            'type' => 'select',
            'option_category' => 'configuration',
            'default' => 'column',
            'options' => [
                'column' => esc_html__('Column', DMPRO_TEXTDOMAIN),
                'row' => esc_html__('Row', DMPRO_TEXTDOMAIN),
            ],
            'mobile_options' => true,
            'toggle_slug' => 'flexbox',
        ];
        ...
        $module_fields['flex_wrap'] = [
            'label' => esc_html__('Responsive Grid (Flex Wrap)', DMPRO_TEXTDOMAIN),
            'type' => 'yes_no_button',
            'option_category' => 'configuration',
            'default' => 'on',
            'options' => [
        ...
        $module_fields['justify_content'] = [
            'label' => esc_html__('Grid Alignment', DMPRO_TEXTDOMAIN),
            'type' => 'select',
            'option_category' => 'configuration',
            'default' => 'center',
            'options' => [
                'center' => esc_html__('Center', DMPRO_TEXTDOMAIN),
                'flex-start' => esc_html__('Flex Start', DMPRO_TEXTDOMAIN),
                'flex-end' => esc_html__('Flex End', DMPRO_TEXTDOMAIN),
        ...
        $module_fields['align_items'] = [
            'label' => esc_html__('Align Items', DMPRO_TEXTDOMAIN),
            'type' => 'select',
            'option_category' => 'configuration',
            'default' => 'baseline',
            'options' => [
                'baseline' => esc_html__('Baseline', DMPRO_TEXTDOMAIN),
                'center' => esc_html__('Center', DMPRO_TEXTDOMAIN),
                'flex-start' => esc_html__('Flex Start', DMPRO_TEXTDOMAIN),
                'flex-end' => esc_html__('Flex End', DMPRO_TEXTDOMAIN),
            ],
