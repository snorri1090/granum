...
class DMPRO_Timeline_Item extends ET_Builder_Module {
	...
	public $module_url = DMPRO_MODULES_URL . 'TimeLineItem' . '/';
	
    public function init()
    {
        $this->name = esc_html__('Timeline Event', DMPRO_TEXTDOMAIN);
        $this->plural = esc_html__('Timeline Events', DMPRO_TEXTDOMAIN);
        $this->slug = 'dmpro_timeline_item';
        $this->vb_support = 'on';
        $this->main_css_element = '%%order_class%%.dmpro_timeline_item';
        $this->type = 'child';
        $this->advanced_setting_title_text = esc_html__('Timeline Event', DMPRO_TEXTDOMAIN);
        ...
        $this->settings_modal_toggles = [
                ...
                'toggles' => [
                    'event_card' => [
                        'sub_toggles' => [
                            ...
                            'title' => esc_html__('Event Card', DMPRO_TEXTDOMAIN),
                            'priority' => 1,
                        ],
                    'timeline_icon' => esc_html__('Timeline Icon', DMPRO_TEXTDOMAIN),
                ],
            ],
            'advanced' => [
                'toggles' => [
                    ...
                    'timeline_icon_settings' => esc_html__('Timeline Icon', DMPRO_TEXTDOMAIN),
                    'icon_settings' => esc_html__('Image & Icon', DMPRO_TEXTDOMAIN),
                    'text_group' => [
                        'title' => esc_html__('Text', DMPRO_TEXTDOMAIN),
                        'tabbed_subtoggles' => true,
                        'sub_toggles' => [
                            'title' => [
                                'name' => 'Title',
                    ...
                    'button' => [
                        'title' => esc_html__('Button', DMPRO_TEXTDOMAIN),
                        'priority' => 55,
                    ],
                    'width' => [
            ...
            'custom_css' => [
                'toggles' => [
                    'attributes' => [
                        'title' => esc_html__('Attributes', DMPRO_TEXTDOMAIN),
                        'priority' => 95,
                    ],
                ],
            ],
        ...
        $this->advanced_fields = array(
            'fonts' => array(
                'header' => array(
                    'label' => esc_html__('Event Card Title', DMPRO_TEXTDOMAIN),
                    'css' => array(
                ...
                'body' => array(
                    'label' => esc_html__('Event Card Description', DMPRO_TEXTDOMAIN),
                    'css' => array(
                ...
                'date_text' => array(
                    'label' => esc_html__('Date/Milestone', DMPRO_TEXTDOMAIN),
                    'css' => array(
            ...
            'borders' => array(
                'default' => array(
                    ...
                    'label_prefix' => esc_html__('Event Card', DMPRO_TEXTDOMAIN),
                    'tab_slug' => 'advanced',
                ...
                'date_text' => array(
                    ...
                    'label_prefix' => esc_html__('Date/Milestone', DMPRO_TEXTDOMAIN),
                    'tab_slug' => 'advanced',
                    'toggle_slug' => 'event_card',
            ...
            'box_shadow' => array(
                'default' => array(
                    'label' => esc_html__('Event Card Box Shadow', DMPRO_TEXTDOMAIN),
                ...
                'image' => array(
                    'label' => esc_html__('Image Box Shadow', DMPRO_TEXTDOMAIN),
                    'option_category' => 'layout',
                    'tab_slug' => 'advanced',
                    'toggle_slug' => 'icon_settings',
                    'show_if' => array(
        ...
        $this->custom_css_fields = array(
            'timeline_item_image' => array(
                'label' => esc_html__('Timeline Event Image', DMPRO_TEXTDOMAIN),
                'selector' => '.dmpro_timeline_item_image',
            ),
            'timeline_item_title' => array(
                'label' => esc_html__('Timeline Event Title', DMPRO_TEXTDOMAIN),
                'selector' => '.dmpro_timeline_item_header',
            ),
            'timeline_item_content' => array(
                'label' => esc_html__('Timeline Event Content', DMPRO_TEXTDOMAIN),
                'selector' => '.dmpro_timeline_item_content',
            ),
            'timeline_item_button' => array(
                'label' => esc_html__('Timeline Event Button', DMPRO_TEXTDOMAIN),
            ...
            'timeline_item_date_text' => array(
                'label' => esc_html__('Timeline Event Date/Milestone Text', DMPRO_TEXTDOMAIN),
                'selector' => '.dmpro_timeline_date .dmpro_timeline_date_text',
			),
			'timeline_item_icon' => array(
                'label' => esc_html__('Timeline Icon', DMPRO_TEXTDOMAIN),
                'selector' => '.date-icon',
            ),
        ...
        $this->help_videos = array(
            array(
                'id' => 'XW7HR86lp8U',
                'name' => esc_html__('An introduction to the Timeline Event module', DMPRO_TEXTDOMAIN),
            ),
        );
    }
    ...
    public function get_fields()
    {
        ...
        if (!is_rtl()) {
            $image_icon_placement['left'] = esc_html__('Left', DMPRO_TEXTDOMAIN);
        } else {
            $image_icon_placement['right'] = esc_html__('Right', DMPRO_TEXTDOMAIN);
        }
        ...
        $fields = array(
            'admin_label' => array(
                ...
                'description' => esc_html__('This will change the label of the module in the builder for easy identification.', DMPRO_TEXTDOMAIN),
            ),
            'date' => array(
                'label' => esc_html__('Date/Milestone', DMPRO_TEXTDOMAIN),
                'type' => 'text',
                'option_category' => 'basic_option',
                'description' => esc_html__('The date or milestone title that displays with your timeline event.', DMPRO_TEXTDOMAIN),
                'toggle_slug' => 'event_card',
            ...
            'title' => array(
                'label' => esc_html__('Event Title', DMPRO_TEXTDOMAIN),
                'type' => 'text',
                'option_category' => 'basic_option',
                'description' => esc_html__('The title of your timeline event that will display within the timeline event card.', DMPRO_TEXTDOMAIN),
                'toggle_slug' => 'event_card',
                'sub_toggle' => 'event_card_text',
                'dynamic_content' => 'text',
                'mobile_options' => true,
            ...
            'content' => array(
                'label' => esc_html__('Event Description', DMPRO_TEXTDOMAIN),
                'type' => 'tiny_mce',
                'option_category' => 'basic_option',
                'description' => esc_html__('Input a description for the timeline event that will display inside the timeline event card.', DMPRO_TEXTDOMAIN),
                'toggle_slug' => 'event_card',
                'sub_toggle' => 'event_card_text',
                'dynamic_content' => 'text',
                'mobile_options' => true,
            ...
            'show_button' => array(
                'label' => esc_html__('Enable Event Button', DMPRO_TEXTDOMAIN),
                'type' => 'yes_no_button',
                'option_category' => 'layout',
                'options' => array(
                ...
                'description' => esc_html__('Enable this option to show a button within the timeline event card.', DMPRO_TEXTDOMAIN),
                'toggle_slug' => 'event_card',
                'sub_toggle' => 'event_card_text',
            ...
            'button_text' => array(
                ...
                'type' => 'text',
                'option_category' => 'basic_option',
                'description' => esc_html__('Input your desired button text, or leave blank for no button.', DMPRO_TEXTDOMAIN),
                'toggle_slug' => 'event_card',
                'sub_toggle' => 'event_card_text',
                'dynamic_content' => 'text',
                'mobile_options' => true,
            ...
            'button_url' => array(
                'label' => esc_html__('Button Link URL', DMPRO_TEXTDOMAIN),
                'type' => 'text',
                'option_category' => 'basic_option',
                'description' => esc_html__('Input the destination URL for your button.', DMPRO_TEXTDOMAIN),
                'toggle_slug' => 'event_card',
                'sub_toggle' => 'event_card_text',
                'dynamic_content' => 'url',
                'show_if' => array(
            ...
            'button_url_new_window' => array(
                ...
                'options' => array(
                    'off' => esc_html__('In The Same Window', DMPRO_TEXTDOMAIN),
                    'on' => esc_html__('In The New Tab', DMPRO_TEXTDOMAIN),
                ),
                'toggle_slug' => 'event_card',
                'sub_toggle' => 'event_card_text',
                'description' => esc_html__('Here you can choose whether or not your link opens in a new window', DMPRO_TEXTDOMAIN),
                'default_on_front' => 'off',
                'show_if' => array(
                    'show_button' => 'on',
                ),
            ...
            'url' => array(
                'label' => esc_html__('Title Link URL', DMPRO_TEXTDOMAIN),
                'type' => 'text',
                'option_category' => 'basic_option',
                'description' => esc_html__('If you would like to make your timeline event a link, input your destination URL here.', DMPRO_TEXTDOMAIN),
                'toggle_slug' => 'link_options',
                'dynamic_content' => 'url',
            ),
            'url_new_window' => array(
                'label' => esc_html__('Title Link Target', DMPRO_TEXTDOMAIN),
                'type' => 'select',
                'option_category' => 'configuration',
                'options' => array(
                    'off' => esc_html__('In The Same Window', DMPRO_TEXTDOMAIN),
            ...
            'timeline_icon' => array(
                ...
                'description' => esc_html__('Choose an icon to display with your timeline Date/Milestone.', DMPRO_TEXTDOMAIN),
                'mobile_options' => true,
                'hover' => 'tabs',
                'default' => '%%43%%',
            ),
            'timeline_icon_color' => array(
                ...
                'type' => 'color-alpha',
                'description' => esc_html__('Here you can define a custom color for your icon.', DMPRO_TEXTDOMAIN),
                'tab_slug' => 'advanced',
            ...
            'date_use_circle' => array(
                ...
                'tab_slug' => 'advanced',
                'toggle_slug' => 'timeline_icon_settings',
                'description' => esc_html__('Here you can choose whether icon set above should display within a circle.', DMPRO_TEXTDOMAIN),
                'default' => 'on',
            ),
            'date_circle_color' => array(
                ...
                'type' => 'color-alpha',
                'description' => esc_html__('Here you can define a custom color for the icon circle.', DMPRO_TEXTDOMAIN),
                'show_if' => array(
                    'date_use_circle' => 'on',
                ),
                'tab_slug' => 'advanced',
            ...
            'date_use_circle_border' => array(
                ...
                'description' => esc_html__('Here you can choose whether if the icon circle border should display.', DMPRO_TEXTDOMAIN),
                'show_if' => array(
                    'date_use_circle' => 'on',
                ),
                'tab_slug' => 'advanced',
            ...
            'date_circle_border_color' => array(
                ...
                'type' => 'color-alpha',
                'description' => esc_html__('Here you can define a custom color for the icon circle border.', DMPRO_TEXTDOMAIN),
                'show_if' => array(
            ...
            'date_use_icon_font_size' => array(
                ...
                'description' => esc_html__('If you would like to control the size of the icon, you must first enable this option.', DMPRO_TEXTDOMAIN),
                'type' => 'yes_no_button',
            ...
            'timeline_icon_font_size' => array(
                ...
                'description' => esc_html__('Control the size of the icon by increasing or decreasing the font size.', DMPRO_TEXTDOMAIN),
                'type' => 'range',
                'option_category' => 'font_option',
                'tab_slug' => 'advanced',
                'toggle_slug' => 'timeline_icon_settings',
            ...
            'date_text_bgcolor' => array(
                'label' => esc_html__('Background Color of Date/Milestone', DMPRO_TEXTDOMAIN),
                'type' => 'color-alpha',
                'description' => esc_html__('Here you can define a custom color for the Date/Milestone Text.', DMPRO_TEXTDOMAIN),
                'tab_slug' => 'advanced',
                'toggle_slug' => 'event_card',
                'sub_toggle' => 'date_text_settings',
                'hover' => 'tabs',
            ...
            'use_icon' => array(
                'label' => esc_html__('Use Icon', DMPRO_TEXTDOMAIN),
                'type' => 'yes_no_button',
                'option_category' => 'basic_option',
                'options' => array(
                    'off' => esc_html__('No', DMPRO_TEXTDOMAIN),
                ...
                'description' => esc_html__('Here you can choose whether icon set below should be used.', DMPRO_TEXTDOMAIN),
                'default_on_front' => 'off',
            ),
            'font_icon' => array(
                ...
                'toggle_slug' => 'event_card',
                'sub_toggle' => 'image',
                'description' => esc_html__('Choose an icon to display with your timeline item.', DMPRO_TEXTDOMAIN),
                'show_if' => array(
                    'use_icon' => 'on',
                ),
                'mobile_options' => true,
            ...
            'image' => array(
                ...
                'type' => 'upload',
                'option_category' => 'basic_option',
                'upload_button_text' => esc_html__('Upload an image', DMPRO_TEXTDOMAIN),
                'choose_text' => esc_attr__('Choose an Image', DMPRO_TEXTDOMAIN),
                'update_text' => esc_attr__('Set As Image', DMPRO_TEXTDOMAIN),
                'show_if' => array(
                    'use_icon' => 'off',
                ),
                'description' => esc_html__('Upload an image to display at the top of your timeline item.', DMPRO_TEXTDOMAIN),
                'toggle_slug' => 'event_card',
                'sub_toggle' => 'image',
            ...
            'icon_placement' => array(
                'label' => esc_html__('Image/Icon Placement', DMPRO_TEXTDOMAIN),
                'type' => 'select',
                'option_category' => 'layout',
                'options' => $image_icon_placement,
                'tab_slug' => 'advanced',
                'toggle_slug' => 'icon_settings',
                'description' => esc_html__('Here you can choose where to place the icon.', DMPRO_TEXTDOMAIN),
                'default_on_front' => 'top',
                'mobile_options' => true,
            ),
            'icon_alignment' => array(
                'label' => esc_html__('Image/Icon Alignment', DMPRO_TEXTDOMAIN),
                'description' => esc_html__('Align image/icon to the left, right or center.', DMPRO_TEXTDOMAIN),
                'type' => 'align',
                'option_category' => 'layout',
            ...
            'image_max_width' => array(
                ...
                'description' => esc_html__('Adjust the width of the image within the timeline item.', DMPRO_TEXTDOMAIN),
                'type' => 'range',
                'option_category' => 'layout',
                'tab_slug' => 'advanced',
                'toggle_slug' => 'width',
            ...
            'custom_card_arrow' => array(
                'label' => esc_html__('Use Custom Styling for Event Card Arrow', DMPRO_TEXTDOMAIN),
                'description' => esc_html__('Use different styling from parent setting for Event Card Arrow', DMPRO_TEXTDOMAIN),
                'type' => 'yes_no_button',
                'options' => array(
                    'off' => esc_html__('No', DMPRO_TEXTDOMAIN),
                    'on' => esc_html__('Yes', DMPRO_TEXTDOMAIN),
            ...
            'card_arrow_size' => array(
                'label' => esc_html__('Event Card Arrow Size', DMPRO_TEXTDOMAIN),
                'description' => esc_html__('Event Card Arrow Size', DMPRO_TEXTDOMAIN),
                'type' => 'range',
                'option_category' => 'configuration',
                'tab_slug' => 'advanced',
                'toggle_slug' => 'event_card',
            ...
            'card_arrow_color' => array(
                'default' => $et_accent_color,
                'label' => esc_html__('Event Card Arrow Color', DMPRO_TEXTDOMAIN),
                'type' => 'color-alpha',
                'description' => esc_html__('Here you can define a custom color for card arrow.', DMPRO_TEXTDOMAIN),
                'tab_slug' => 'advanced',
                'toggle_slug' => 'event_card',
                'sub_toggle' => 'card_arrow_settings',
                'default' => '#eaebec',
            ...
            'card_width' => array(
                'label' => esc_html__('Event Card Width', DMPRO_TEXTDOMAIN),
                'type' => 'range',
                'option_category' => 'layout',
                'tab_slug' => 'advanced',
                'toggle_slug' => 'width',
            ...
            'card_max_width' => array(
                'label' => esc_html__('Event Card Max Width', DMPRO_TEXTDOMAIN),
                'description' => esc_html__('Adjust the width of the card within the timeline item.', DMPRO_TEXTDOMAIN),
                'type' => 'range',
                'option_category' => 'layout',
                'tab_slug' => 'advanced',
                'toggle_slug' => 'width',
    ...
    public function render($attrs, $content, $render_slug)
    {
        ...
        if ('' !== $card_max_width_tablet || '' !== $card_max_width_phone || '' !== $card_max_width) {
            ...
            et_pb_responsive_options()->generate_responsive_css($card_max_width_values, '%%order_class%% .dmpro_timeline_item_card', 'max-width', $render_slug);
        }
