...
class DMPRO_PopUP extends ET_Builder_Module {
	...
	public $module_url = DMPRO_MODULES_URL . 'Popup' . '/';
	...
	public function init() {
		$this->name = esc_html__( DMPRO_PREFIX . 'Popup', DMPRO_TEXTDOMAIN );
		...
		$this->settings_modal_toggles = [
				'general'  => [
					'toggles' => [
					'main_content' => esc_html__( 'Popup Settings', DMPRO_TEXTDOMAIN ),
					'popup_content' => [
						'sub_toggles' => [
							'popup_header' => [
								'name' => 'Header',
						...
						'title' => esc_html__('Popup Content', DMPRO_TEXTDOMAIN),
						'priority' => 1,
					],
					'background'   => esc_html__( 'Background', DMPRO_TEXTDOMAIN ),
				],
			],
			'advanced' => [
				'toggles' => [
					'text'               => esc_html__( 'Click Trigger Alignment', DMPRO_TEXTDOMAIN ),
					'trigger_button'     => esc_html__( 'Button Click Trigger', DMPRO_TEXTDOMAIN ),
					'trigger_text'       => esc_html__( 'Text Click Trigger', DMPRO_TEXTDOMAIN ),
					'trigger_icon'       => esc_html__( 'Icon Click Trigger', DMPRO_TEXTDOMAIN ),
					'trigger_image'      => esc_html__( 'Image Click Trigger', DMPRO_TEXTDOMAIN ),
					'popup_text' => [
						'sub_toggles' => [
							'popup_title_text' => [
								'name' => 'Header',
						...
						'tabbed_subtoggles' => true,
						'title' => esc_html__('Popup Text', DMPRO_TEXTDOMAIN),
						'priority' => 3,
					],
					'popup_close_icon'   => esc_html__( 'Popup Close Icon', DMPRO_TEXTDOMAIN ),
					'popup_close_button' => esc_html__( 'Footer Close Button', DMPRO_TEXTDOMAIN ),
					'box_shadow'         => esc_html__( 'Popup Box Shadows', DMPRO_TEXTDOMAIN ),
					'border'             => esc_html__( 'Popup Borders', DMPRO_TEXTDOMAIN ),
					'popup_sizing'       => esc_html__( 'Popup Size & Position', DMPRO_TEXTDOMAIN ),
				],
			],
		];
	}
	public function get_fields() {
		...
		$list_layout    = array();
		$list_layout[0] = esc_html__( 'Select', DMPRO_TEXTDOMAIN );
		...
		$module_fields['popup_id_notice'] = [
				...
				'value'           => true,
				'display_if'      => true,
				'message'         => esc_html__( 'Please give the popup a unique name below (Example: popup-1).', DMPRO_TEXTDOMAIN ),
				'show_if'     	  => array(
					'popup_id' => array( '' ),
				),
				'tab_slug'         => 'general',
			...
			$module_fields['popup_close_icon_notice'] = [
				...
				'value'           => true,
				'display_if'      => true,
				'message'         => esc_html__( 'Popup close icon disabled. Please enable it to use its setting here.', DMPRO_TEXTDOMAIN ),
				'show_if'     	  => array(
					'show_close_icon' => 'off',
				),
				'tab_slug'         => 'advanced',
			...
			$module_fields['popup_button_trigger_notice'] = [
				...
				'value'           => true,
				'display_if'      => true,
				'message'         => esc_html__( 'You do not have a Button Click Trigger Selected (under Popup Settings), so these settings here will have no effect.', DMPRO_TEXTDOMAIN ),
				'show_if_not'     	  => array(
			...
			$module_fields['popup_text_trigger_notice'] = [
				...
				'value'           => true,
				'display_if'      => true,
				'message'         => esc_html__( 'You do not have a Text Click Trigger Selected (under Popup Settings), so these settings here will have no effect.', DMPRO_TEXTDOMAIN ),
				'show_if_not'     	  => array(
			...
			$module_fields['popup_footer_button_notice'] = [
				...
				'value'           => true,
				'display_if'      => true,
				'message'         => esc_html__( 'You do not have the footer button enabled (Under Popup Content), so these settings here will have no effect.', DMPRO_TEXTDOMAIN ),
				'show_if_not'          => array(
					'show_footer' => 'on',
				),
				'tab_slug'         => 'advanced',
			...
			$module_fields['popup_id'] = [
					'label'            => esc_html__( 'Unique Popup Name', DMPRO_TEXTDOMAIN ),
					'type'             => 'text',
					...
					'tab_slug'         => 'general',
					'toggle_slug'      => 'main_content',
					'description'      => esc_html__( 'Enter a unique popup name. This is needed for the popup to function correctly.', DMPRO_TEXTDOMAIN ),
			];
			$module_fields['trigger_type'] = [
					'label'            => esc_html__( 'Popup Trigger Type', DMPRO_TEXTDOMAIN ),
					'type'             => 'select',
					'option_category'  => 'configuration',
					'options'          => array(
						'element'      => esc_html__( 'Click Trigger', DMPRO_TEXTDOMAIN ),
						'on_page_load' => esc_html__( 'Timed Delay Trigger', DMPRO_TEXTDOMAIN ),
						'exit_intent'  => esc_html__( 'Exit Intent Trigger', DMPRO_TEXTDOMAIN ),
					),
					'default'          => 'element',
					'default_on_front' => 'element',
					'tab_slug'         => 'general',
					'toggle_slug'      => 'main_content',
					'description'      => esc_html__( 'Select how you want your popup to be triggered.', DMPRO_TEXTDOMAIN ),
				];
			$module_fields['trigger_delay'] = [
					'label'            => esc_html__( 'Timed Delay', DMPRO_TEXTDOMAIN ),
					'type'             => 'range',
					...
					'tab_slug'         => 'general',
					'toggle_slug'      => 'main_content',
					'description'      => esc_html__( 'Set how long of a delay after the page loads until the popup triggers.', DMPRO_TEXTDOMAIN),
				];
			$module_fields['re_rendering'] = [
					'label'            => esc_html__( 'Continuously Load Popup on Page Reload?', DMPRO_TEXTDOMAIN ),
					'type'             => 'yes_no_button',
					'option_category'  => 'configuration',
					'options'          => array(
					...
					'tab_slug'         => 'general',
					'toggle_slug'      => 'main_content',
					'description'      => esc_html__( 'Turn this option off to load the popup only once.', DMPRO_TEXTDOMAIN),
				];
			$module_fields['trigger_element_type'] = [
					'label'            => esc_html__( 'Click Trigger Element', DMPRO_TEXTDOMAIN ),
					'type'             => 'select',
					'option_category'  => 'configuration',
					'options'          => array(
						'button'     	=> esc_html__( 'Button', DMPRO_TEXTDOMAIN ),
						'image'      	=> esc_html__( 'Image', DMPRO_TEXTDOMAIN ),
						'icon'       	=> esc_html__( 'Icon', DMPRO_TEXTDOMAIN ),
						'text'       	=> esc_html__( 'Text', DMPRO_TEXTDOMAIN ),
						'element_id' 	=> esc_html__( 'CSS ID (of another element on the page)', DMPRO_TEXTDOMAIN ),
						'element_class' => esc_html__( 'CSS Class (of another element on the page)', DMPRO_TEXTDOMAIN ),
					),
					'default'          => 'button',
					...
					'tab_slug'         => 'general',
					'toggle_slug'      => 'main_content',
					'description'      => esc_html__( 'Select what type of element you would like to use to trigger the popup when clicked.', DMPRO_TEXTDOMAIN),
				];
			$module_fields['trigger_element_id'] = [
					'label'           => esc_html__( 'Element CSS ID', DMPRO_TEXTDOMAIN ),
					'type'            => 'text',
					'option_category' => 'basic_option',
					'show_if'         => array(
						'trigger_type'         => 'element',
					...
					'tab_slug'        => 'general',
					'toggle_slug'     => 'main_content',
					'description'     => esc_html__( 'Enter the CSS ID (without #) of another element on the page that you want to trigger this popup when clicked.', DMPRO_TEXTDOMAIN),
				];
			$module_fields['trigger_element_class'] = [
					'label'           => esc_html__( 'Element CSS Class', DMPRO_TEXTDOMAIN ),
					'type'            => 'text',
					'option_category' => 'basic_option',
					'show_if'         => array(
						'trigger_type'         => 'element',
					...
					'tab_slug'        => 'general',
					'toggle_slug'     => 'main_content',
					'description'     => esc_html__( 'Enter the CSS Class (without . ) of another element on the page that you want to trigger this popup when clicked.', DMPRO_TEXTDOMAIN),
				];
			$module_fields['trigger_button_text'] = [
					...
					'tab_slug'         => 'general',
					'toggle_slug'      => 'main_content',
					'description'        => esc_html__( 'Input the text for the button that you want to trigger the popup when clicked.', DMPRO_TEXTDOMAIN),
				];
			$module_fields['trigger_icon'] = [
					...
					'tab_slug'         => 'general',
					'toggle_slug'      => 'main_content',
					'description'      => esc_html__( 'Select an icon to be used for the popup click trigger.', DMPRO_TEXTDOMAIN),
				];
			$module_fields['trigger_image'] = [
					...
					'tab_slug'           => 'general',
					'toggle_slug'        => 'main_content',
					'description'        => esc_html__( 'Add the image that you would like to trigger the popup when clicked.', DMPRO_TEXTDOMAIN),
				];
			$module_fields['trigger_image_alt'] = [
					'label'           => esc_html__( 'Image Alternative Text', DMPRO_TEXTDOMAIN ),
					'type'            => 'text',
					'option_category' => 'basic_option',
					'show_if'         => array(
						'trigger_type'         => 'element',
					...
					'tab_slug'        => 'general',
					'toggle_slug'     => 'main_content',
					'description'     => esc_html__( 'Input the text to be used for alternative text of the popup click trigger image.', DMPRO_TEXTDOMAIN),
				];
			$module_fields['trigger_text'] = [
					'label'            => esc_html__( 'Text', DMPRO_TEXTDOMAIN ),
					'type'             => 'text',
					'option_category'  => 'basic_option',
					...
					'tab_slug'         => 'general',
					'toggle_slug'      => 'main_content',
					'description'      => esc_html__( 'Input the text that you want to trigger the popup when clicked.', DMPRO_TEXTDOMAIN),
				];
			$module_fields['close_on_esc'] = [
					'label'            => esc_html__( 'Allow ESC Key to Close Popup?', DMPRO_TEXTDOMAIN ),
					'type'             => 'yes_no_button',
					'option_category'  => 'configuration',
					'options'          => array(
						'off' => esc_html__( 'No', DMPRO_TEXTDOMAIN ),
					...
					'tab_slug'         => 'general',
					'toggle_slug'      => 'main_content',
					'description'      => esc_html__( 'Enable this option to allow the ESC key to close the popup.', DMPRO_TEXTDOMAIN),
				];
			$module_fields['show_header'] = [
					'label'            => esc_html__( 'Enable Popup Header', DMPRO_TEXTDOMAIN ),
					'type'             => 'yes_no_button',
					'option_category'  => 'configuration',
					'options'          => array(
						'off' => esc_html__( 'No', DMPRO_TEXTDOMAIN ),
					...
					'description'      => esc_html__( 'Enable this option to show a header in the popup.', DMPRO_TEXTDOMAIN),
				];
			$module_fields['show_popup_title'] = [
					'label'            => esc_html__( 'Enable Popup Header Title', DMPRO_TEXTDOMAIN ),
					'type'             => 'yes_no_button',
					'option_category'  => 'configuration',
					'options'          => array(
						'off' => esc_html__( 'No', DMPRO_TEXTDOMAIN ),
					...
					'toggle_slug'      => 'popup_content',
					'sub_toggle' 	   => 'popup_header',
					'description'      => esc_html__( 'Enable this option to show the title within the header of the popup.', DMPRO_TEXTDOMAIN)
				];
			$module_fields['popup_title'] = [
					'label'           => esc_html__( 'Popup Header Title', DMPRO_TEXTDOMAIN ),
					'type'            => 'text',
					'option_category' => 'basic_option',
					'show_if'         => array(
						'show_header'      => 'on',
					...
					'toggle_slug'      => 'popup_content',
					'sub_toggle' 	   => 'popup_header',
					'description'     => esc_html__( 'Input the text for the title within the header of the popup.', DMPRO_TEXTDOMAIN)
				];
			$module_fields['show_close_icon'] = [
					'label'            => esc_html__( 'Show Popup Close Icon', DMPRO_TEXTDOMAIN ),
					'type'             => 'yes_no_button',
					'option_category'  => 'configuration',
					'options'          => array(
						'off' => esc_html__( 'No', DMPRO_TEXTDOMAIN ),
					...
					'toggle_slug'      => 'popup_content',
					'sub_toggle' 	   => 'popup_header',
					'description'      => esc_html__( 'Enable this option to show the popup close icon.', DMPRO_TEXTDOMAIN)
				];
			$module_fields['show_footer'] = [
					'label'            => esc_html__( 'Enable Popup Footer Close Button', DMPRO_TEXTDOMAIN ),
					'type'             => 'yes_no_button',
					'option_category'  => 'configuration',
					'options'          => array(
						'off' => esc_html__( 'No', DMPRO_TEXTDOMAIN ),
					...
					'description'      => esc_html__( 'Enable this option to show a footer in the popup.', DMPRO_TEXTDOMAIN),
				];
			$module_fields['close_button_text'] = [
					'label'            => esc_html__( 'Footer Close Button Text', DMPRO_TEXTDOMAIN ),
					'type'             => 'text',
					'option_category'  => 'basic_option',
					'default'          => 'Close',
					...
					'toggle_slug'      => 'popup_content',
					'sub_toggle' 	   => 'popup_footer',
					'description'      => esc_html__( 'Enter the text for the footer close button.', DMPRO_TEXTDOMAIN),
				];
			$module_fields['popup_content_type'] = [
					'label'            => esc_html__( 'Popup Content Type', DMPRO_TEXTDOMAIN ),
					'type'             => 'select',
					'option_category'  => 'configuration',
					'options'          => array(
						'text'   => esc_html__( 'Text (or Shortcode)', DMPRO_TEXTDOMAIN ),
						'image'  => esc_html__( 'Image', DMPRO_TEXTDOMAIN ),
						'video'  => esc_html__( 'Video', DMPRO_TEXTDOMAIN ),
						'layout' => esc_html__( 'Divi Library', DMPRO_TEXTDOMAIN ),
					),
					'default'          => 'text',
					'default_on_front' => 'text',
					'toggle_slug'      => 'popup_content',
					'sub_toggle' 	   => 'popup_body',
					'description'      => esc_html__( 'Select what type of content you want to display inside of the popup body.', DMPRO_TEXTDOMAIN),
				];
			$module_fields['content'] = [
					'label'           => esc_html__( 'Enter Text (or Shortcode)', DMPRO_TEXTDOMAIN ),
					'type'            => 'tiny_mce',
					'option_category' => 'basic_option',
					'show_if'         => array(
					...
					'toggle_slug'      => 'popup_content',
					'sub_toggle' 	   => 'popup_body',
					'description'     => esc_html__( 'Enter the text that you want displayed in the body of the popup. You can also paste a shortcode in this area.', DMPRO_TEXTDOMAIN),
				];
			$module_fields['popup_content_image'] = [
					...
					'toggle_slug'      => 'popup_content',
					'sub_toggle' 	   => 'popup_body',
					'description'        => esc_html__( 'Select the image that you would like to display in the body of the popup.', DMPRO_TEXTDOMAIN),
				];
			$module_fields['popup_content_image_alt'] = [
					...
					'toggle_slug'      => 'popup_content',
					'sub_toggle' 	   => 'popup_body',
					'description'     => esc_html__( 'Input the text to be used for alternative text of the image within the body of the popup.', DMPRO_TEXTDOMAIN),
				];
			$module_fields['popup_content_video'] = [
					'label'              => esc_html__( 'Video MP4 File Or URL', DMPRO_TEXTDOMAIN ),
					'type'               => 'upload',
					'option_category'    => 'basic_option',
					'data_type'          => 'video',
					'upload_button_text' => esc_attr__( 'Upload a video', DMPRO_TEXTDOMAIN ),
					'choose_text'        => esc_attr__( 'Choose a Video MP4 File', DMPRO_TEXTDOMAIN ),
					'update_text'        => esc_attr__( 'Set As Video', DMPRO_TEXTDOMAIN ),
					'show_if'            => array(
						'popup_content_type' => 'video',
					),
					'toggle_slug'      => 'popup_content',
					'sub_toggle' 	   => 'popup_body',
					'description'        => esc_html__( 'Upload your desired video in .MP4 format, or enter in the URL of the video you would like to display inside the body of the popup.', DMPRO_TEXTDOMAIN ),
				];
			$module_fields['autoplay_video'] = [
					'label'            => esc_html__( 'Autoplay Video', DMPRO_TEXTDOMAIN ),
					'type'             => 'yes_no_button',
					'option_category'  => 'configuration',
					'options'          => array(
						'off' => esc_html__( 'No', DMPRO_TEXTDOMAIN ),
					...
					'toggle_slug'      => 'popup_content',
					'sub_toggle' 	   => 'popup_body',
					'description'      => esc_html__( 'Enable this option to auto play the video when the popup is triggered. This option works for YouTube, Vimeo, and uploaded videos from the media library.', DMPRO_TEXTDOMAIN),
				];
			$module_fields['popup_content_layout'] = [
					'label'            => esc_html__( 'Select Divi Library Layout', DMPRO_TEXTDOMAIN ),
					'type'             => 'select',
					'option_category'  => 'configuration',
					'options'          => $list_layout,
					'show_if'          => array(
					...
					'toggle_slug'      => 'popup_content',
					'sub_toggle' 	   => 'popup_body',
					'description'      => esc_html__( 'Select a layout from your Divi Library to display within the body of the popup.', DMPRO_TEXTDOMAIN ),
				];
			$module_fields['trigger_icon_font_size'] = [
					'label'            => esc_html__( 'Icon Click Trigger Font Size', DMPRO_TEXTDOMAIN ),
					'type'             => 'range',
					...
					'description'      => esc_html__( 'Set the size of the icon for the popup click trigger.', DMPRO_TEXTDOMAIN ),

				];
			$module_fields['trigger_icon_color'] = [
					'label'            => esc_html__( 'Icon Click Trigger Color', DMPRO_TEXTDOMAIN ),
					'type'             => 'color-alpha',
					'default'          => '#8300e9',
					...
					'tab_slug'         => 'advanced',
					'toggle_slug'    => 'trigger_icon',
					'description'      => esc_html__( 'Set the color of the icon for the popup click trigger.', DMPRO_TEXTDOMAIN ),
				];
			$module_fields['popup_custom_margin'] = [
					'label'            => esc_html__( 'Popup Margin', DMPRO_TEXTDOMAIN ),
					'type'             => 'custom_margin',
					'option_category'  => 'layout',
					'mobile_options'   => true,
					'default'          => '',
					...
					'description'      => esc_html__( 'Margin adds extra space to the outside of the element, increasing the distance between the element and other items on the page.', DMPRO_TEXTDOMAIN ),
				];
			$module_fields['popup_custom_padding'] = [
					'label'            => esc_html__( 'Popup Padding', DMPRO_TEXTDOMAIN ),
					'type'             => 'custom_padding',
					'option_category'  => 'layout',
					'mobile_options'   => true,
					'default'          => '',
					...
					'tab_slug'         => 'advanced',
					'toggle_slug'      => 'margin_padding',
					'description'      => esc_html__( 'Padding adds extra space to the inside of the element, increasing the distance between the edge of the element and its inner contents.', DMPRO_TEXTDOMAIN ),
				];
			$module_fields['popup_header_custom_margin'] = [
					'label'            => esc_html__( 'Popup Header Margin', DMPRO_TEXTDOMAIN ),
					'type'             => 'custom_margin',
					'option_category'  => 'layout',
					'mobile_options'   => true,
					'default'          => '',
			...
			$module_fields['popup_header_custom_padding'] = [
					'label'            => esc_html__( 'Popup Header Padding', DMPRO_TEXTDOMAIN ),
					'type'             => 'custom_padding',
					'option_category'  => 'layout',
					'mobile_options'   => true,
			...
			$module_fields['popup_body_custom_margin'] = [
					'label'            => esc_html__( 'Popup Body Margin', DMPRO_TEXTDOMAIN ),
					'type'             => 'custom_margin',
					'option_category'  => 'layout',
					'mobile_options'   => true,
					'default'          => '',
			...
			$module_fields['popup_body_custom_padding'] = [
					'label'            => esc_html__( 'Popup Body Padding', DMPRO_TEXTDOMAIN ),
					'type'             => 'custom_padding',
					'option_category'  => 'layout',
					'mobile_options'   => true,
					'default'          => '25px|25px|25px|25px|true|true',
			...
			$module_fields['popup_footer_custom_margin'] = [
					'label'            => esc_html__( 'Popup Footer Margin', DMPRO_TEXTDOMAIN ),
					'type'             => 'custom_margin',
					'option_category'  => 'layout',
					'mobile_options'   => true,
					'default'          => '',
			...
			$module_fields['popup_footer_custom_padding'] = [
					'label'            => esc_html__( 'Popup Footer Padding', DMPRO_TEXTDOMAIN ),
					'type'             => 'custom_padding',
					'option_category'  => 'layout',
					'mobile_options'   => true,
					'default'          => '25px|25px|25px|25px|true|true',
			...
			$module_fields['trigger_element_bg_color'] = [
					'label'             => esc_html__( 'Click Trigger Background', DMPRO_TEXTDOMAIN ),
					...
					'description'       => esc_html__( 'Customize the background style of the Click Trigger Element by adjusting background color, gradient, and image.', DMPRO_TEXTDOMAIN ),
				];
			$module_fields['popup_overlay_bg_color'] = [
					'label'             => esc_html__( 'Popup Background Overlay', DMPRO_TEXTDOMAIN ),
					'type'              => 'background-field',
					...
					'tab_slug'          => 'general',
					'toggle_slug'       => 'background',
					'description'       => esc_html__( 'Customize the background overlay by adjusting background color, gradient, and image.', DMPRO_TEXTDOMAIN ),
				];
			$module_fields['popup_bg_color'] = [
					'label'             => esc_html__( 'Popup Background', DMPRO_TEXTDOMAIN ),
					'type'              => 'background-field',
					'base_name'         => 'popup_bg',
					...
					'tab_slug'          => 'general',
					'toggle_slug'       => 'background',
					'description'       => esc_html__( 'Customize the background of the popup by adjusting background color, gradient, and image.', DMPRO_TEXTDOMAIN ),
				];
			$module_fields['popup_header_bg_color'] = [
					'label'             => esc_html__( 'Popup Header Background', DMPRO_TEXTDOMAIN ),
					'type'              => 'background-field',
					...
					'tab_slug'          => 'general',
					'toggle_slug'       => 'background',
					'description'       => esc_html__( 'Customize the background of the popup header by adjusting background color, gradient, and image.', DMPRO_TEXTDOMAIN ),
				];
			$module_fields['popup_body_bg_color'] = [
					'label'             => esc_html__( 'Popup Body Background', DMPRO_TEXTDOMAIN ),
					'type'              => 'background-field',
					...
					'tab_slug'          => 'general',
					'toggle_slug'       => 'background',
					'description'       => esc_html__( 'Customize the background of the popup body by adjusting background color, gradient, and image.', DMPRO_TEXTDOMAIN ),
				];
			$module_fields['popup_footer_bg_color'] = [
					'label'             => esc_html__( 'Popup Footer Background', DMPRO_TEXTDOMAIN ),
					'type'              => 'background-field',
					...
					'tab_slug'          => 'general',
					'toggle_slug'       => 'background',
					'description'       => esc_html__( 'Customize the background of the popup footer by adjusting background color, gradient, and image.', DMPRO_TEXTDOMAIN ),
				];
			...
			$module_fields['popup_close_icon_font_size'] = [
					'label'            => esc_html__( 'Popup Close Icon Font Size', DMPRO_TEXTDOMAIN ),
					'type'             => 'range',
					'option_category'  => 'font_option',
					'range_settings'   => array(
						'min'  => '1',
					...
					'tab_slug'         => 'advanced',
					'toggle_slug' => 'popup_close_icon',
					'description'      => esc_html__( 'Set the font size of the popup close button icon.', DMPRO_TEXTDOMAIN ),
				];
			$module_fields['popup_close_icon_color'] = [
					'label'            => esc_html__( 'Popup Close Icon Color', DMPRO_TEXTDOMAIN ),
					'type'             => 'color-alpha',
					'default'          => '#212121',
					...
					'tab_slug'         => 'advanced',
					'toggle_slug' => 'popup_close_icon',
					'description'      => esc_html__( 'Choose the color for the popup close button icon.', DMPRO_TEXTDOMAIN ),
				];
			$module_fields['popup_position'] = [
					'label'            => esc_html__( 'Popup Position', DMPRO_TEXTDOMAIN ),
					'type'             => 'select',
					'option_category'  => 'configuration',
					'options'          => array(
						'top_left'      => esc_html__( 'Top Left', DMPRO_TEXTDOMAIN ),
						'top_right'     => esc_html__( 'Top Right', DMPRO_TEXTDOMAIN ),
						'top_center'    => esc_html__( 'Top Center', DMPRO_TEXTDOMAIN ),
						'bottom_left'   => esc_html__( 'Bottom Left', DMPRO_TEXTDOMAIN ),
						'bottom_right'  => esc_html__( 'Bottom Right', DMPRO_TEXTDOMAIN ),
						'bottom_center' => esc_html__( 'Bottom Center', DMPRO_TEXTDOMAIN ),
					...
					'description'      => esc_html__( 'Select the position of the popup on the page.', DMPRO_TEXTDOMAIN ),
				];
			$module_fields['popup_animation_style'] = [
					'label'           => esc_html__( 'Popup Animation Style', DMPRO_TEXTDOMAIN ),
					'type'            => 'select_animation',
					'option_category' => 'configuration',
					'options'         => array(
						'none'   => esc_html__( 'None', DMPRO_TEXTDOMAIN ),
						'fade'   => esc_html__( 'Fade', DMPRO_TEXTDOMAIN ),
					...
					'description'     => esc_html__( 'Pick an animation style to enable animations for this popup. Once enabled, you will be able to customize your animation style further. To disable animations, choose the None option.', DMPRO_TEXTDOMAIN ),
				];
			$module_fields['popup_animation_direction'] = [
					'label'           => esc_html__( 'Popup Animation Direction', DMPRO_TEXTDOMAIN ),
					'type'            => 'select',
					'option_category' => 'configuration',
					'options'         => array(
					...
					'tab_slug'        => 'advanced',
					'toggle_slug'     => 'animation',
					'description'     => esc_html__( 'Pick from up to five different animation directions, each of which will adjust the starting and ending position of your animated element.', DMPRO_TEXTDOMAIN ),
				];
			$module_fields['popup_animation_duration'] = [
					'label'           => esc_html__( 'Popup Animation Duration', DMPRO_TEXTDOMAIN ),
					'type'            => 'range',
					'option_category' => 'configuration',
					'range_settings'  => array(
						'min'  => 0,
					...
					'tab_slug'        => 'advanced',
					'toggle_slug'     => 'animation',
					'description'     => esc_html__( 'Speed up or slow down your animation by adjusting the animation duration. Units are in milliseconds and the default animation duration is one second.', DMPRO_TEXTDOMAIN ),
				];
			$module_fields['popup_animation_intensity'] = [
					'label'           => esc_html__( 'Popup Animation Intensity', DMPRO_TEXTDOMAIN ),
					'type'            => 'range',
					'option_category' => 'configuration',
					'range_settings'  => array(
						'min'  => 0,
					...
					'tab_slug'        => 'advanced',
					'toggle_slug'     => 'animation',
					'description'     => esc_html__( 'Intensity effects how subtle or aggressive your animation will be. Lowering the intensity will create a smoother and more subtle animation while increasing the intensity will create a snappier more aggressive animation.', DMPRO_TEXTDOMAIN ),
				];
			$module_fields['popup_animation_starting_opacity'] = [
					'label'           => esc_html__( 'Popup Animation Starting Opacity', DMPRO_TEXTDOMAIN ),
					'type'            => 'range',
					'option_category' => 'configuration',
					'range_settings'  => array(
						'min'       => 0,
					...
					'tab_slug'        => 'advanced',
					'toggle_slug'     => 'animation',
					'description'     => esc_html__( 'By increasing the starting opacity, you can reduce or remove the fade effect that is applied to all animation styles.', DMPRO_TEXTDOMAIN ),
				];
			$module_fields['popup_animation_speed_curve'] = [
					'label'           => esc_html__( 'Popup Animation Speed Curve', DMPRO_TEXTDOMAIN ),
					'type'            => 'select',
					'option_category' => 'configuration',
					'options'         => array(
						'ease-in-out' => esc_html__( 'Ease-In-Out', DMPRO_TEXTDOMAIN ),
						'ease'        => esc_html__( 'Ease', DMPRO_TEXTDOMAIN ),
						'ease-in'     => esc_html__( 'Ease-In', DMPRO_TEXTDOMAIN ),
						'ease-out'    => esc_html__( 'Ease-Out', DMPRO_TEXTDOMAIN ),
						'linear'      => esc_html__( 'Linear', DMPRO_TEXTDOMAIN ),
					),
					'mobile_options'  => true,
					'default'         => 'ease-in-out',
					'show_if_not'     => array(
					...
					'tab_slug'        => 'advanced',
					'toggle_slug'     => 'animation',
					'description'     => esc_html__( 'Here you can adjust the easing method of your animation. Easing your animation in and out will create a smoother effect when compared to a linear speed curve.', DMPRO_TEXTDOMAIN ),
				];
		...
		return array(
			'fonts'=> array(
				'popup_title_text' => array(
					'label'=> esc_html__( 'Popup Title', DMPRO_TEXTDOMAIN ),
					'font_size' => array(
						'default' => '22px',
						'range_settings' => array(
							'min'  => '1',
				...
				'popup_body_text' => array(
					'label' => esc_html__( 'Popup Body', DMPRO_TEXTDOMAIN ),
					'font_size' => array(
						'default' => '15px',
						'range_settings' => array(
							'min'  => '1',
				...
				'popup_trigger_text' => array(
					...
					'label' => esc_html__( 'Click Trigger Text', DMPRO_TEXTDOMAIN ),
					'font_size' => array(
						'default' => '18px',
						'range_settings' => array(
							'min'  => '1',
			...
			'button' => array(
				'trigger_button' => array(
					'label' => esc_html__( 'Click Trigger Button', DMPRO_TEXTDOMAIN ),
					'css' => array(
				...
				'close_button' => array(
					'label' => esc_html__( 'Footer Close Button', DMPRO_TEXTDOMAIN ),
					'css' => array(
			...
			'box_shadow' => array(
				'default' => false,
				'trigger_element' => array(
					'label' => esc_html__( 'Click Trigger Box Shadow', DMPRO_TEXTDOMAIN ),
					'show_if'        => array(
						'trigger_type'         => 'element',
					),
					'css' => array(
				...
				'popup' => array(
					'label'       => esc_html__( 'Popup Box Shadow', DMPRO_TEXTDOMAIN ),
					'css'         => array(
				...
				'popup_header' => array(
					'label' => esc_html__( 'Popup Header Box Shadow', DMPRO_TEXTDOMAIN ),
					'show_if'        => array(
						'show_header'         => 'on',
					),
					'css'  => array(
				...
				'popup_footer' => array(
					'label' => esc_html__( 'Popup Footer Box Shadow', DMPRO_TEXTDOMAIN ),
					'show_if'        => array(
						'show_footer'         => 'on',
					),
					'css' => array(
			...
			'max_width' => array(
				'extra' => array(
					'popup' => array(
						'options' => array(
							'width' => array(
								'label' => esc_html__( 'Popup Width', DMPRO_TEXTDOMAIN ),
								'range_settings' => array(
									'min'  => 1,
									'max'  => 100,
									'step' => 1,
			...
			'height' => array(
				'extra' => array(
					'popup' => array(
						'options'        => array(
							'height' => array(
								'label' => esc_html__( 'Popup Height', DMPRO_TEXTDOMAIN ),
								'range_settings' => array(
									'min'  => 1,
									'max'  => 100,
									'step' => 1,
			...
			'text' => array(
				...
				'options' => array(
					'text_orientation' => array(
						'label' => esc_html__( 'Click Trigger Alignment', DMPRO_TEXTDOMAIN ),
						'default'          => 'center',
						'show_if'        => array(
							'trigger_type'         => 'element',
						),
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		wp_enqueue_script("dmpro-".$this->slug, $this->module_url . 'custom.js', array(), DMPRO_VERSION, true);
		...
		if ( 'on' === $show_footer ) {
			$close_button_text  = '' !== $close_button_text ? $close_button_text : esc_html__( 'Close', DMPRO_TEXTDOMAIN );
